...
def preprocess_image_cv2_rancrop_flip_make_hint(img_A, img_B, teacher_model):
    ...
    return images_A, images_B, hints, soft_labels



def load_images_with_crop_flip_data_aug_and_hint(path, n_images):
