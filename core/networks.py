...
def DPTE_Net():
    ...
    model = Model(inputs=inputs, outputs=[conv10, guided_fm])
    return model
...
#     merge6 = concatenate([drop4,up6], axis = 3)
#     conv6 = ConvBlock(merge6, int(8*num_filters_1st), 3,  act_type="swish")
#     conv6 = PoolingTransformerBlock(conv6, int(8*num_filters_1st), 4)
#     conv6 = PoolingTransformerBlock(conv6, int(8*num_filters_1st), 4)
...
#     merge7 = concatenate([conv3,up7], axis = 3)
#     conv7 = ConvBlock(merge7, int(4*num_filters_1st), 3,  act_type="swish")
#     conv7 = PoolingTransformerBlock(conv7, int(4*num_filters_1st), 4)
#     conv7 = PoolingTransformerBlock(conv7, int(4*num_filters_1st), 4)
   
#     up8 = ConvBlock((UpSampling2D(size = (2,2))(conv7)), int(2*num_filters_1st), 2, act_type="swish")
#     merge8 = concatenate([conv2,up8], axis = 3)
#     conv8 = ConvBlock(merge8, int(2*num_filters_1st), 3,  act_type="swish")
#     conv8 = PoolingTransformerBlock(conv8, int(2*num_filters_1st), 4)
#     conv8 = PoolingTransformerBlock(conv8, int(2*num_filters_1st), 4)

#     up9 = ConvBlock((UpSampling2D(size = (2,2))(conv8)), int(num_filters_1st), 2, act_type="swish")
#     merge9 = concatenate([conv1,up9], axis = 3)
#     conv9 = ConvBlock(merge9, int(num_filters_1st), 3,  act_type="swish")
#     conv9 = PoolingTransformerBlock(conv9, int(num_filters_1st), 4)
#     conv9 = PoolingTransformerBlock(conv9, int(num_filters_1st), 4)
...
# ### DPTE_Net Model (Residual-Decoder)
# def DPTE_Net():
...
#     up6 = ConvBlock((UpSampling2D(size = (2,2))(drop5)), int(8*num_filters_1st), 2, act_type="leakyrelu")
#     merge6 = concatenate([drop4,up6], axis = 3)
#     conv6 = ConvBlock(merge6, int(8*num_filters_1st), 3,  act_type="leakyrelu")
#     conv6 = ConvBlock(conv6, int(8*num_filters_1st), 3,  act_type="leakyrelu")
#     conv6 = ConvBlock(conv6, int(8*num_filters_1st), 3,  act_type="leakyrelu")
#     conv6 = Add()([conv6, up6])
    
#     up7 = ConvBlock((UpSampling2D(size = (2,2))(conv6)), int(4*num_filters_1st), 2, act_type="leakyrelu")
#     merge7 = concatenate([conv3,up7], axis = 3)
#     conv7 = ConvBlock(merge7, int(4*num_filters_1st), 3,  act_type="leakyrelu")
#     conv7 = ConvBlock(conv7, int(4*num_filters_1st), 3,  act_type="leakyrelu")
#     conv7 = ConvBlock(conv7, int(4*num_filters_1st), 3,  act_type="leakyrelu")
#     conv7 = Add()([conv7, up7])
   
#     up8 = ConvBlock((UpSampling2D(size = (2,2))(conv7)), int(2*num_filters_1st), 2, act_type="leakyrelu")
#     merge8 = concatenate([conv2,up8], axis = 3)
#     conv8 = ConvBlock(merge8, int(2*num_filters_1st), 3,  act_type="leakyrelu")
#     conv8 = ConvBlock(conv8, int(2*num_filters_1st), 3,  act_type="leakyrelu")
#     conv8 = ConvBlock(conv8, int(2*num_filters_1st), 3,  act_type="leakyrelu")
#     conv8 = Add()([conv8, up8])

#     up9 = ConvBlock((UpSampling2D(size = (2,2))(conv8)), int(num_filters_1st), 2, act_type="leakyrelu")
#     merge9 = concatenate([conv1,up9], axis = 3)
#     conv9 = ConvBlock(merge9, int(num_filters_1st), 3,  act_type="leakyrelu")
#     conv9 = ConvBlock(conv9, int(num_filters_1st), 3,  act_type="leakyrelu")
#     conv9 = ConvBlock(conv9, int(num_filters_1st), 3,  act_type="leakyrelu")
#     conv9 = Add()([conv9, up9])
...
# ### DPTE_Net Model (SubPixel-Decoder)
# def DPTE_Net():
...
#     up6 = ConvBlock(SubPixel(drop5, 2), int(8*num_filters_1st), 2, act_type="leakyrelu")
#     merge6 = concatenate([drop4,up6], axis = 3)
#     conv6 = ConvBlock(merge6, int(8*num_filters_1st), 3,  act_type="leakyrelu")
#     conv6 = ConvBlock(conv6, int(8*num_filters_1st), 3,  act_type="leakyrelu")
#     conv6 = ConvBlock(conv6, int(8*num_filters_1st), 3,  act_type="leakyrelu")
    
#     up7 = ConvBlock(SubPixel(conv6, 2), int(4*num_filters_1st), 2, act_type="leakyrelu")
#     merge7 = concatenate([conv3,up7], axis = 3)
#     conv7 = ConvBlock(merge7, int(4*num_filters_1st), 3,  act_type="leakyrelu")
#     conv7 = ConvBlock(conv7, int(4*num_filters_1st), 3,  act_type="leakyrelu")
#     conv7 = ConvBlock(conv7, int(4*num_filters_1st), 3,  act_type="leakyrelu")
   
#     up8 = ConvBlock(SubPixel(conv7, 2), int(2*num_filters_1st), 2, act_type="leakyrelu")
#     merge8 = concatenate([conv2,up8], axis = 3)
#     conv8 = ConvBlock(merge8, int(2*num_filters_1st), 3,  act_type="leakyrelu")
#     conv8 = ConvBlock(conv8, int(2*num_filters_1st), 3,  act_type="leakyrelu")
#     conv8 = ConvBlock(conv8, int(2*num_filters_1st), 3,  act_type="leakyrelu")

#     up9 = ConvBlock(SubPixel(conv8, 2), int(num_filters_1st), 2, act_type="leakyrelu")
#     merge9 = concatenate([conv1,up9], axis = 3)
#     conv9 = ConvBlock(merge9, int(num_filters_1st), 3,  act_type="leakyrelu")
#     conv9 = ConvBlock(conv9, int(num_filters_1st), 3,  act_type="leakyrelu")
#     conv9 = ConvBlock(conv9, int(num_filters_1st), 3,  act_type="leakyrelu")
